...
export const articles: Article[] = [
  // NOVO ARTIGO - Proteção Patrimonial
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Introdução: Por que proteger seu patrimônio nunca foi tão importante</h2>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Estratégia 1: Holdings Patrimoniais – A Blindagem Corporativa</h2>
      ...
      <div class="my-8 space-y-6">
        <div class="bg-card border border-border p-8 rounded-sm shadow-sm">
          <h4 class="font-medium text-lg mb-4">Vantagens Fundamentais:</h4>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Estratégia 2: Diversificação Jurisdicional</h2>
      ...
      <div class="grid md:grid-cols-2 gap-6 my-8">
        <div class="p-6 border border-border rounded-sm">
          <h5 class="font-medium mb-3">Para Holdings Internacionais</h5>
        ...
        <div class="p-6 border border-border rounded-sm">
          <h5 class="font-medium mb-3">Para Investimentos</h5>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Estratégia 3: Separação Patrimonial Pessoa Física x Pessoa Jurídica</h2>
      ...
      <div class="bg-zinc-100 dark:bg-white/5 p-6 rounded-sm my-6">
        <h5 class="font-medium mb-2">Guia de Implementação:</h5>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Estratégia 4: Seguros Patrimoniais e de Responsabilidade Civil</h2>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Estratégia 5: Planejamento Sucessório</h2>
      ...
      <div class="mt-16 p-10 bg-card border border-border rounded-[2.5rem] text-center shadow-xl relative overflow-hidden group">
        ...
        <h3 class="text-3xl font-medium mb-4 font-source-serif-pro">Sua estratégia de proteção começa com um diagnóstico.</h3>
        ...
        <a 
          ...
          class="inline-block bg-foreground text-background px-12 py-5 rounded-none font-medium text-lg hover:scale-105 transition-all duration-300 shadow-xl"
        >
  ...
  // ARTIGO 01 - Planejamento Patrimonial 2026
  {
    ...
    content: `
      ...
      <div class="bg-card border border-border rounded-sm p-8 my-10 shadow-sm">
        <h3 class="text-xl font-medium mb-6 font-source-serif-pro">Sumário</h3>
      ...
      <h2 id="introducao" class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Introdução</h2>
      ...
      <h2 id="o-que-e-holding" class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">O que é uma Holding Internacional?</h2>
      ...
      <h2 id="o-que-e-offshore" class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">O que é uma Empresa Offshore?</h2>
      ...
      <h2 id="beneficios" class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Benefícios Estratégicos</h2>
      <div class="grid md:grid-cols-2 gap-6 my-10">
        <div class="p-8 border border-border rounded-sm bg-card/50">
          <h5 class="font-medium mb-3">Proteção Patrimonial</h5>
        ...
        <div class="p-8 border border-border rounded-sm bg-card/50">
          <h5 class="font-medium mb-3">Otimização Tributária</h5>
        ...
        <div class="p-8 border border-border rounded-sm bg-card/50">
          <h5 class="font-medium mb-3">Confidencialidade</h5>
        ...
        <div class="p-8 border border-border rounded-sm bg-card/50">
          <h5 class="font-medium mb-3">Planejamento Sucessório</h5>
      ...
      <h2 id="jurisdicoes" class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Jurisdições Estratégicas para 2025</h2>
      ...
      <h2 id="passo-a-passo" class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Passo a Passo de Implementação</h2>
      <div class="grid gap-6 my-10">
        <div class="flex gap-6 p-6 border-b border-border">
          ...
          <div>
            <h4 class="font-medium mb-1">Diagnóstico Estratégico</h4>
        ...
        <div class="flex gap-6 p-6 border-b border-border">
          ...
          <div>
            <h4 class="font-medium mb-1">Seleção da Jurisdição</h4>
        ...
        <div class="flex gap-6 p-6 border-b border-border">
          ...
          <div>
            <h4 class="font-medium mb-1">Implementação e Banco</h4>
      ...
      <div class="mt-20 p-10 bg-foreground text-background rounded-[2.5rem] text-center shadow-xl relative overflow-hidden group">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro text-background">Estrutura sua Holding Internacional</h3>
        ...
        <a 
          ...
          class="inline-block bg-background text-foreground px-12 py-5 rounded-none font-medium text-lg hover:scale-105 transition-all duration-300 shadow-xl"
        >
  ...
  },
  {
    ...
    slug: "guia-definitivo-planejamen",
    readTime: "12 min",
    content: `
      <div class="mb-12">
        <p class="text-xl text-muted-foreground font-light leading-relaxed">
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">1. O Fim da Era da Reatividade</h2>
      ...
      <div class="p-6 bg-zinc-100 dark:bg-white/5 rounded-sm mb-8 border-l-4 border-primary">
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">2. A Holding Internacional como Escudo de Proteção</h2>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">3. Planejamento Sucessório: Evitando o Inventário</h2>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">4. O Papel dos Ativos Digitais e Criptoativos</h2>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro text-primary/90">Conclusão: O Patrimônio é seu, a estratégia é nossa.</h2>
      ...
      <div class="mt-20 p-10 bg-card border border-border rounded-[2.5rem] text-center shadow-xl">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro">Proteja seu Legado em 2026</h3>
        <p class="text-muted-foreground max-w-2xl mx-auto text-lg mb-8 font-light">
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">1. O Dilema das Chaves Privadas: Herança ou Perda?</h2>
      ...
      <div class="space-y-6 my-10">
        <div class="p-6 border border-border rounded-sm bg-card/50">
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">2. A Tributação de Cripto em 2026: Brasil vs. Exterior</h2>
      ...
      <div class="bg-zinc-100 dark:bg-white/5 p-8 rounded-sm my-8">
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">3. Proteção Patrimonial e Blindagem Digital</h2>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">4. Tokenização de Ativos Reais (RWA)</h2>
      ...
      <div class="my-12 p-8 border-l-4 border-primary bg-muted/30">
        <h3 class="text-xl font-medium mb-4">O Desafio da Conformidade (Compliance)</h3>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Conclusão: O Futuro do seu Legado é Digital</h2>
      ...
      <div class="mt-20 p-10 bg-card border border-border rounded-[2.5rem] text-center shadow-xl">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro">Sua estratégia Web3 está pronta?</h3>
        <p class="text-muted-foreground max-w-2xl mx-auto text-lg mb-8 font-light">
  ...
  // ARTIGO 03 - Recorde Holdings Internacionais
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">O Fim da Alíquota Fixa e o Impacto no Caixa das Famílias</h2>
      ...
      <div class="p-8 bg-zinc-100 dark:bg-white/5 rounded-sm my-8">
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Criptoativos no Radar da Receita</h2>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">A Ascensão de Dubai e Paraguai</h2>
      <div class="grid md:grid-cols-2 gap-6 my-10">
        <div class="p-6 border border-border rounded-sm">
          <h4 class="font-medium mb-3">Dubai</h4>
        ...
        <div class="p-6 border border-border rounded-sm">
          <h4 class="font-medium mb-3">Paraguai</h4>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">O que esperar para o restante de 2026?</h2>
      ...
      <div class="mt-20 p-10 bg-card border border-border rounded-[2.5rem] text-center shadow-xl">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro">Não deixe seu legado ao acaso</h3>
        <p class="max-w-2xl mx-auto text-lg mb-8 opacity-80 font-light">
  ...
  // ARTIGO 04 - Reorganização Societária
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">O "Pedágio" nos Dividendos</h2>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">A Fuga para a Internacionalização</h2>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Reajuste do IRPF e a "Nova Pejotização"</h2>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">O Papel do Planejamento em 2026</h2>
      ...
      <div class="mt-20 p-10 bg-card border border-border rounded-[2.5rem] text-center shadow-xl">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro">Recalcule sua Estrutura Societária</h3>
        <p class="text-muted-foreground max-w-2xl mx-auto text-lg mb-8 font-light">
  ...
  // ARTIGO 05 - Grande Migração Patrimonial
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">1. O “Tsunami” do ITCMD: Estados abandonam alíquotas fixas</h2>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">2. Dividendos: A mordida de 10% no topo da pirâmide</h2>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">3. Criptoativos: O fim da era do "radar desligado"</h2>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">4. O Triângulo de Ouro: Dubai, Paraguai e Reino Unido</h2>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Conclusão: O Custo da Inércia</h2>
      ...
      <div class="mt-20 p-10 bg-card border border-border rounded-[2.5rem] text-center shadow-xl">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro">Seu patrimônio está em governança?</h3>
        <p class="text-muted-foreground max-w-2xl mx-auto text-lg mb-8 font-light">
...

  {
    ...
    content: `
      ...
      <div class="flex items-center gap-4 mb-10 pb-6 border-b border-border">
        <div class="h-14 w-14 rounded-none overflow-hidden bg-zinc-200 ring-2 ring-primary/20">
          <img src="/vinicius-icone-perfil.jpeg" alt="Vinicius Borges" class="w-full h-full object-cover" />
        </div>
        <div>
          <p class="font-medium text-xl text-foreground">Vinicius Borges</p>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">A Regra dos "10-10-10": O Contraste com o Custo Brasil</h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 my-10 font-medium text-center uppercase tracking-tighter">
        <div class="p-8 border border-border rounded-sm bg-card shadow-sm group hover:border-primary transition-all">
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">A “Lei da Maquila” e a Expansão Industrial</h2>
      ...
      <div class="p-8 bg-zinc-100 dark:bg-white/5 rounded-sm my-10 font-light flex items-start gap-4 italic leading-relaxed">
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro text-primary/90">O Boom Imobiliário e a Soberania em Dólar</h2>
      ...
      <div class="grid md:grid-cols-2 gap-6 my-10">
        <div class="p-6 border border-border rounded-sm">
          <h4 class="font-medium mb-3">Rentabilidade</h4>
        ...
        <div class="p-6 border border-border rounded-sm">
          <h4 class="font-medium mb-3">Soberania Cambial</h4>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">Conclusão: Estratégia, não Distância</h2>
      ...
      <div class="mt-20 p-10 bg-card border border-border rounded-[2.5rem] text-center shadow-xl">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro">Sua internacionalização começa aqui</h3>
        <p class="text-muted-foreground max-w-2xl mx-auto text-lg mb-8 font-light">
  ...
  // ARTIGO 19 - Tesouro de Maduro Bitcoin (ÚNICO)
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Introdução: A Captura e a Pergunta de US$ 60 Bilhões</h2>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro text-primary/90">A Arquitetura Jurídica das Sombras</h2>
      
      <h3 class="text-2xl font-medium mb-4">O Arquiteto: Alex Saab, o Agente Duplo</h3>
      ...
      <h3 class="text-2xl font-medium mb-4">O Mensageiro: David Nicolas Rubio Gonzalez</h3>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-8 font-source-serif-pro">O Esquema de Blindagem Financeira: As 4 Etapas</h2>
      
      <div class="grid md:grid-cols-2 gap-6 my-10">
        <div class="p-8 border border-border rounded-sm bg-card hover:border-primary/40 transition-colors">
          <div class="text-primary font-medium text-3xl mb-4">01</div>
          <h4 class="font-medium text-xl mb-3">Extração e Exportação</h4>
        ...
        <div class="p-8 border border-border rounded-sm bg-card hover:border-primary/40 transition-colors">
          <div class="text-primary font-medium text-3xl mb-4">02</div>
          <h4 class="font-medium text-xl mb-3">Refinamento em Mercados Alternativos</h4>
        ...
        <div class="p-8 border border-border rounded-sm bg-card hover:border-primary/40 transition-colors">
          <div class="text-primary font-medium text-3xl mb-4">03</div>
          <h4 class="font-medium text-xl mb-3">Lavagem via Criptomoedas</h4>
        ...
        <div class="p-8 border border-border rounded-sm bg-card hover:border-primary/40 transition-colors">
          <div class="text-primary font-medium text-3xl mb-4">04</div>
          <h4 class="font-medium text-xl mb-3">Ocultação Inviolável</h4>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">O Paradoxo Brasileiro: Quando a Justiça Consegue (e Não Consegue)</h2>
      ...
      <div class="overflow-x-auto my-12">
        <table class="w-full text-sm text-left border border-border rounded-sm overflow-hidden">
          <thead class="bg-muted">
            <tr>
              <th class="p-4 border-b border-border font-medium text-foreground">Cenário de Ativos</th>
              <th class="p-4 border-b border-border font-medium text-foreground">Eficácia da Justiça</th>
              <th class="p-4 border-b border-border font-medium text-foreground">Exemplo Real</th>
            </tr>
          </thead>
          <tbody>
            <tr class="hover:bg-muted/50">
              <td class="p-4 border-b border-border font-medium">Bancos (Exterior)</td>
              <td class="p-4 border-b border-border text-green-600 font-medium">Alta</td>
            ...
            <tr class="hover:bg-muted/50">
              ...
              <td class="p-4 border-b border-border text-orange-600 font-medium">Média a Alta</td>
            ...
            <tr class="hover:bg-muted/50">
              ...
              <td class="p-4 border-b border-border text-red-600 font-medium">Inexistente</td>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">Conclusão: A Nova Fronteira da Soberania</h2>
      ...
      <div class="mt-20 p-10 bg-foreground text-background rounded-[2.5rem] shadow-2xl group overflow-hidden relative">
        <div class="relative z-10">
          <h3 class="text-3xl font-medium mb-6 font-source-serif-pro text-background">Proteção e Estruturação Digital</h3>
  ...
  // Artigos adicionais sem conteúdo completo (placeholders)
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Jurisdições para o Mercado Digital: Análise Técnica</h2>

      <div class="space-y-12">
        <!-- Dubai -->
        <section>
          <h3 class="text-2xl font-medium mb-4 text-primary">1. Dubai (Emirados Árabes Unidos)</h3>
          ...
          <div class="bg-card border border-border p-6 rounded-sm mb-4">
        ...
        <!-- Estônia -->
        <section>
          <h3 class="text-2xl font-medium mb-4 text-primary">2. Estônia (Tributação Diferida)</h3>
        ...
        <!-- Geórgia -->
        <section>
          <h3 class="text-2xl font-medium mb-4 text-primary">3. Geórgia (Small Business Regime)</h3>
        ...
        <!-- Paraguai e Outros -->
        <section>
          <h3 class="text-2xl font-medium mb-4 text-primary">4. Paraguai e Panamá</h3>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-8 font-source-serif-pro">Matriz Estratégica: Perfil vs. Jurisdição</h2>
      <div class="overflow-hidden border border-border rounded-sm my-10">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr class="bg-card border-b border-border">
              <th class="p-4 font-medium">Perfil</th>
              <th class="p-4 font-medium">Estratégia Ideal</th>
            </tr>
          </thead>
          <tbody>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">O Que Realmente Funciona em 2026</h2>
      ...
      <div class="mt-20 p-10 bg-foreground text-background rounded-[2.5rem] text-center shadow-xl">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro">Planeje sua Internacionalização Digital</h3>
        <p class="max-w-2xl mx-auto text-lg mb-8 opacity-80 font-light">
        ...
        <a 
          ...
          class="inline-block bg-background text-foreground px-12 py-5 rounded-none font-medium text-lg hover:scale-105 transition-all duration-300"
        >
          Consultar Especialista
        </a>
      </div>
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Por que abrir empresa no Reino Unido?</h2>
      ...
      <div class="bg-card border border-border p-8 rounded-sm my-10 shadow-sm font-light">
        <h4 class="font-medium mb-4">Estrutura Societária: Private Limited Company (LTD)</h4>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Passo a Passo Técnico de Implementação</h2>
      <div class="space-y-8 my-10 font-light">
        <div>
          <h4 class="font-medium text-lg mb-2">1. Registro na Companies House</h4>
        ...
        <div>
          <h4 class="font-medium text-lg mb-2">2. Registro Fiscal junto à HMRC</h4>
        ...
        <div>
          <h4 class="font-medium text-lg mb-2">3. Abrir Conta Bancária Funcional</h4>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">Tributação e Conformidade em 2025</h2>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">O Ponto Crítico: Substância Econômica</h2>
      ...
      <div class="mt-20 p-10 bg-card border border-border rounded-[2.5rem] text-center shadow-xl">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro">Estruture sua LTD com Segurança Jurídica</h3>
        <p class="text-muted-foreground max-w-2xl mx-auto text-lg mb-8 font-light">
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">O Contexto: Por Que Internacionalizar em 2025?</h2>
      ...
      <div class="space-y-8 my-10">
        <div class="p-8 border border-border rounded-sm bg-card/50">
          <h3 class="text-xl font-medium mb-4">A Estrutura Jurídica Implementada</h3>
          <div class="space-y-6">
            <div>
              <h4 class="font-medium mb-2">1. Empresa em Zona Franca (Free Zone)</h4>
            ...
            <div>
              <h4 class="font-medium mb-2">2. Residência Fiscal e Migratória</h4>
            ...
            <div>
              <h4 class="font-medium mb-2">3. Planejamento Sucessório</h4>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">Por Que Dubai?</h2>
      ...
      <div class="bg-zinc-100 dark:bg-white/5 p-8 rounded-sm my-10 border border-border">
        <h4 class="font-medium mb-4 font-source-serif-pro text-xl">Aspectos Tributários Relevantes</h4>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">Conclusão: Internacionalização não é Fuga, é Planejamento</h2>
      ...
      <div class="mt-20 p-10 bg-foreground text-background rounded-[2.5rem] text-center shadow-xl relative overflow-hidden group">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro text-background">Realize sua Avaliação Estratégica</h3>
        <p class="max-w-2xl mx-auto text-lg mb-8 opacity-80 font-light">
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">O que é Residência Fiscal?</h2>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Vantagens Estratégicas do Paraguai</h2>
      <div class="grid md:grid-cols-2 gap-8 my-10">
        <div class="p-6 border border-border rounded-sm bg-card">
          <h4 class="font-medium mb-3">Eficiência Tributária</h4>
        ...
        <div class="p-6 border border-border rounded-sm bg-card">
          <h4 class="font-medium mb-3">Planejamento Sucessório</h4>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">O Processo em 3 Etapas Fundamentais</h2>
      <div class="space-y-8 my-10">
        <div>
          <h4 class="font-medium border-b border-border pb-2 mb-4 text-xl">1. Residência Permanente</h4>
        ...
        <div>
          <h4 class="font-medium border-b border-border pb-2 mb-4 text-xl">2. Registro Tributário (RUC)</h4>
        ...
        <div>
          <h4 class="font-medium border-b border-border pb-2 mb-4 text-xl">3. Saída Fiscal do Brasil</h4>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro text-destructive/80">Riscos de Planejamento Inadequado</h2>
      ...
      <div class="mt-20 p-10 bg-card border border-border rounded-[2.5rem] text-center shadow-xl">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro">Planeje sua Residência Internacional</h3>
        <p class="text-muted-foreground max-w-2xl mx-auto text-lg mb-8 font-light">
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">1. Consolidação do Marco Legal</h2>
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">2. Tributação de Ganho de Capital em 2025</h2>
      ...
      <div class="bg-card border border-border p-8 rounded-sm my-10 shadow-sm font-light">
        <h4 class="font-medium mb-4">Exchanges Estrangeiras e Estruturas Offshore</h4>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">3. Staking, DeFi e Novas Fronteiras</h2>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">4. Planejamento Tributário e Governança</h2>
      ...
      <div class="mt-20 p-10 bg-foreground text-background rounded-[2.5rem] text-center shadow-xl">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro text-background">Regularize sua Carteira de Criptoativos</h3>
        <p class="max-w-2xl mx-auto text-lg mb-8 opacity-80 font-light">
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">O que é um MSB?</h2>
      ...
      <div class="space-y-8 my-10">
        <div class="p-8 border border-border rounded-sm bg-card">
          <h3 class="text-xl font-medium mb-4">Registro Federal vs. Licenciamento Estadual</h3>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">Passo a Passo para Estruturação</h2>
      <div class="space-y-6 mb-10">
        <div>
          <h4 class="font-medium text-lg mb-1">1. Constituição e Governança</h4>
        ...
        <div>
          <h4 class="font-medium text-lg mb-1">2. Programa de AML e KYC</h4>
        ...
        <div>
          <h4 class="font-medium text-lg mb-1">3. Registro no FinCEN</h4>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">Riscos de Operar sem Conformidade</h2>
      ...
      <div class="mt-20 p-10 bg-card border border-border rounded-[2.5rem] text-center shadow-xl">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro">Licencie sua Fintech nos Estados Unidos</h3>
        <p class="text-muted-foreground max-w-2xl mx-auto text-lg mb-8 font-light">
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">O que é uma Offshore em Dubai?</h2>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-8 font-source-serif-pro">Offshore vs Free Zone vs Mainland</h2>
      <div class="grid md:grid-cols-3 gap-6 my-10 font-light">
        <div class="p-6 border border-border rounded-sm bg-card/50">
          <h4 class="font-medium mb-3 text-primary">Offshore</h4>
        ...
        <div class="p-6 border border-border rounded-sm bg-card/50">
          <h4 class="font-medium mb-3 text-primary">Free Zone</h4>
          <ul class="text-xs space-y-2 text-muted-foreground">
        ...
        <div class="p-6 border border-border rounded-sm bg-card/50">
          <h4 class="font-medium mb-3 text-primary">Mainland</h4>
          <ul class="text-xs space-y-2 text-muted-foreground">
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">Vantagens para Brasileiros</h2>
      <div class="space-y-8 my-10 leading-relaxed font-light">
        <section>
          <h3 class="text-xl font-medium mb-2">1. Eficiência Tributária</h3>
        ...
        <section>
          <h3 class="text-xl font-medium mb-2">2. Proteção Patrimonial</h3>
        ...
        <section>
          <h3 class="text-xl font-medium mb-2">3. Confidencialidade e Segurança</h3>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">O Processo de Constituição</h2>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">Aspectos Críticos: O Olhar Brasileiro</h2>
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">O que é Legal Growth?</h2>
      ...
      <div class="my-10 space-y-6">
        <div class="p-8 border border-border rounded-sm bg-card shadow-sm">
          <h3 class="text-xl font-medium mb-4">Pilares da Estrutura Digital</h3>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">A Importância da Estrutura Societária</h2>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">Propriedade Intelectual como Ativo</h2>
      ...
      <div class="bg-foreground text-background p-10 rounded-[2.5rem] mt-20 text-center shadow-xl">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro text-background">Escale seu Infoproduto com Segurança</h3>
        <p class="max-w-2xl mx-auto text-lg mb-8 opacity-80 font-light">
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Por Que Escolher o Reino Unido?</h2>
      <div class="grid md:grid-cols-2 gap-6 my-10 font-light text-muted-foreground">
        <div class="p-6 border border-border rounded-sm bg-card">
          <h4 class="font-medium mb-2 text-foreground">Credibilidade Global</h4>
        ...
        <div class="p-6 border border-border rounded-sm bg-card">
          <h4 class="font-medium mb-2 text-foreground">Agilidade Digital</h4>
          <p class="text-sm">O registro via Companies House é 100% digital, com aprovações que costumam levar entre 24 a 48 horas.</p>
        </div>
      </div>

      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">A Estrutura Ideal: Private Limited Company (Ltd)</h2>
      ...
      <div class="bg-foreground text-background p-10 rounded-[2.5rem] mt-16 shadow-xl relative overflow-hidden group">
        <h3 class="text-2xl font-medium mb-4 font-source-serif-pro">Passo a Passo para Internacionalização</h3>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">Tributação e Conformidade</h2>
      ...
      <div class="mt-20 p-10 bg-card border border-border rounded-[2.5rem] text-center shadow-xl">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro">Internacionalize sua Operação no Reino Unido</h3>
        <p class="text-muted-foreground max-w-2xl mx-auto text-lg mb-8 font-light">
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Singapura Não é um "Paraíso Fiscal Tradicional"</h2>
      ...
      <div class="grid md:grid-cols-2 gap-8 my-12 font-light">
        <div class="p-8 border border-border rounded-sm bg-card">
          <h3 class="text-xl font-medium mb-4">Eficiência Tributária</h3>
        ...
        <div class="p-8 border border-border rounded-sm bg-card">
          <h3 class="text-xl font-medium mb-4">Segurança Jurídica</h3>
          <ul class="space-y-3 text-muted-foreground text-sm">
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">Hub Financeiro e Governança</h2>
      ...
      <div class="overflow-x-auto my-10">
        <table class="w-full text-sm text-left border-collapse border border-border rounded-sm overflow-hidden">
          <thead class="bg-muted">
            <tr>
              <th class="p-4 border border-border font-medium">Aspecto</th>
              <th class="p-4 border border-border font-medium">Singapura</th>
              <th class="p-4 border border-border font-medium">Offshore Tradicional</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td class="p-4 border border-border font-medium">Reputação</td>
              <td class="p-4 border border-border">Alta (OCDE White)</td>
              <td class="p-4 border border-border">Variável</td>
            </tr>
            <tr>
              <td class="p-4 border border-border font-medium">Tratados</td>
              <td class="p-4 border border-border">Extensos (>90)</td>
              <td class="p-4 border border-border">Limitados</td>
            </tr>
            <tr>
              <td class="p-4 border border-border font-medium">Substância</td>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">Conclusão: Crescimento com Conformidade</h2>
      ...
      <div class="mt-20 p-10 bg-foreground text-background rounded-[2.5rem] text-center shadow-xl">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro text-background">Estrutura sua Operação em Singapura</h3>
        <p class="max-w-2xl mx-auto text-lg mb-8 opacity-80 font-light">
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Por Que a Irlanda se Tornou um Hub Europeu?</h2>
      ...
      <div class="my-10 p-8 border border-border rounded-sm bg-card shadow-sm font-light">
        <h3 class="text-xl font-medium mb-4">Estrutura Jurídica: LTD (Private Limited Company)</h3>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">O Imposto Corporativo de 12,5%</h2>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">Vistos para Empreendedores (STEP)</h2>
      ...
      <div class="overflow-x-auto my-10">
        <table class="w-full text-sm text-left border-collapse border border-border rounded-sm overflow-hidden">
          <thead class="bg-muted">
            <tr>
              <th class="p-4 border border-border font-medium">Critério</th>
              <th class="p-4 border border-border font-medium">Irlanda</th>
              <th class="p-4 border border-border font-medium">Jurisdições UE Tradicionais</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td class="p-4 border border-border font-medium">Imposto operacional</td>
              <td class="p-4 border border-border">12,5%</td>
              <td class="p-4 border border-border">19% – 30%</td>
            </tr>
            <tr>
              <td class="p-4 border border-border font-medium">Sistema jurídico</td>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">Considerações para Brasileiros</h2>
      ...
      <div class="mt-20 p-10 bg-foreground text-background rounded-[2.5rem] text-center shadow-xl">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro text-background">Escale seu Negócio na Europa via Irlanda</h3>
        <p class="max-w-2xl mx-auto text-lg mb-8 opacity-80 font-light">
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-medium mt-12 mb-6 font-source-serif-pro">Por Que Portugal em 2026?</h2>
      ...
      <div class="my-10 p-8 border border-border rounded-sm bg-card shadow-sm">
        <h3 class="text-xl font-medium mb-4">A Estrutura Lda. (Sociedade por Quotas)</h3>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">O Regime Tributário das Empresas</h2>
      ...
      <div class="bg-zinc-100 dark:bg-white/5 p-8 rounded-sm my-10">
        <h4 class="font-medium mb-4">Vantagens para Infoprodutores e Nômades Digitais:</h4>
        <ul class="space-y-3 text-muted-foreground font-light">
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">O Acordo de Bitributação Brasil-Portugal</h2>
      ...
      <h2 class="text-3xl font-medium mt-16 mb-6 font-source-serif-pro">Conclusão: O Momento de Internacionalizar é Agora</h2>
      ...
      <div class="mt-20 p-10 bg-foreground text-background rounded-[2.5rem] text-center shadow-xl">
        <h3 class="text-3xl font-medium mb-6 font-source-serif-pro text-background">Inicie sua Jornada Europeia</h3>
        <p class="max-w-2xl mx-auto text-lg mb-8 opacity-80 font-light">
