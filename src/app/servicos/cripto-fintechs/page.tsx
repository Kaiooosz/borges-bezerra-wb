          ...
          <div className=" relative z-10 px-4">
            ...
            >
              ...
              <h1 className="font-source-serif-pro text-4xl md:text-6xl lg:text-7xl text-foreground mb-6 text-balance">
                ...
                <span className="font-medium">mercado cripto</span>
              </h1>
              <p className="text-xl text-muted-foreground mb-8 text-pretty">
                Especialistas em regulação ativos digitais desde 2017. Licenças,
              ...
              {expertise.map((item, index) => (
                ...
                >
                  <Card className="p-6 bg-card border-border text-center h-full">
                    <div className="text-4xl font-source-serif-pro text-foreground mb-3">
                      {item.year}
                    </div>
                    <h3 className="font-source-serif-pro text-lg text-foreground mb-2">
                      {item.title}
                    </h3>
