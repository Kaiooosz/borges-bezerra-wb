...
export function ServicesPreview() {
  return (
    <section className="py-16 sm:py-20 md:py-24 lg:py-32 bg-backgroud relative">
            ...
            >
              <Link href={service.href}>
                <Card className="group p-6 md:p-8 bg-card border-border hover:border-white/30 transition-all duration-300 h-full cursor-pointer">
                  ...
                  <div className="mt-4 md:mt-6 flex items-center text-foregroung group-hover:translate-x-2 transition-transform">
