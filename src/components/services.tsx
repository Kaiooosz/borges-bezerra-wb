    ...
    <section id="servicos" className="py-16 sm:py-20 md:py-24 bg-backgroud">
      <div className="mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-12 md:mb-16 max-w-3xl mx-auto">
          <h2 className="font-source-serif-pro text-3xl sm:text-4xl md:text-5xl text-foregroung mb-4">
            ...
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-source-serif-pro text-xl text-foregroung mb-3 leading-tight">
                    {service.title}
                  </h3>
