...
import { Bitcoin, ShieldCheck, FileCode, Landmark, ArrowRight } from "lucide-react";

const features = [
  {
    icon: Landmark,
    title: "Licenças MSB",
    subtitle: "VASP e Pagamentos",
    description: "Obtenção de licenças regulatórias em múltiplas jurisdições para operação legal.",
  },
  {
    icon: Bitcoin,
    title: "Exchanges",
    subtitle: "e Wallets",
    description: "Estruturação jurídica completa para plataformas de negociação e custódia de cripto.",
  },
  {
    icon: FileCode,
    title: "Tokenização",
    subtitle: "e Smart Contracts",
    description: "Assessoria jurídica para emissão de tokens, NFTs e contratos inteligentes.",
  },
  {
    icon: ShieldCheck,
    title: "Compliance",
    subtitle: "AML/KYC",
    description: "Implementação de programas de prevenção à lavagem de dinheiro e identificação de clientes.",
  },
];

const benefits = [
  "Operação legal em múltiplas jurisdições",
  "Licenças regulatórias internacionais",
  "Estruturação de ICOs e STOs",
  "Regularização de criptoativos",
  "Compliance completo AML/KYC",
  "Defesa em investigações regulatórias",
];
...
const process = [
  {
    ...
    description: "Mapeamento do modelo de negócio e identificação das licenças necessárias.",
  },
  {
    step: "02",
    title: "Estruturação Jurídica",
    description: "Criação da estrutura corporativa ideal para operação regulada.",
  },
  {
    step: "03",
    title: "Processo de Licença",
    description: "Preparação e submissão de toda documentação regulatória.",
  },
  {
    step: "04",
    title: "Manutenção",
    description: "Suporte contínuo de compliance e renovações regulatórias.",
  },
];
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-[15px] text-muted-foreground font-light max-w-md leading-relaxed mb-10">
              Compliance e estruturação completa para o mercado cripto, fintech e blockchain.
            </p>
            <a
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-[15px] text-muted-foreground font-light max-w-sm mx-auto leading-relaxed mb-10">
              Diagnóstico regulatório com nossos especialistas em cripto e fintechs
            </p>
