...
import { Shield, Building2, FileText, Globe2, ArrowRight } from "lucide-react";

const features = [
  {
    icon: Building2,
    title: "Holdings Familiares",
    subtitle: "e Empresariais",
    description: "Estruturação de holdings nacionais e internacionais para proteção e eficiência tributária.",
  },
  {
    icon: Shield,
    title: "Proteção Lícita",
    subtitle: "do Patrimônio",
    description: "Estratégias legais de proteção contra riscos empresariais e sucessórios.",
  },
  {
    icon: Globe2,
    title: "Trusts",
    subtitle: "e Foundations",
    description: "Criação de estruturas internacionais em jurisdições seguras e estáveis.",
  },
  {
    icon: FileText,
    title: "Ativos Digitais",
    subtitle: "e Propriedade Intelectual",
    description: "Segurança jurídica para marcas, PI, royalties e contratos digitais.",
  },
];
...
const process = [
  {
    ...
    description: "Análise completa do cenário atual e identificação de riscos e oportunidades.",
  },
  {
    step: "02",
    title: "Estratégia Personalizada",
    description: "Desenvolvimento de plano sob medida com estruturas jurídicas adequadas.",
  },
  {
    step: "03",
    title: "Implementação",
    description: "Execução completa com suporte jurídico, contábil e operacional.",
  },
  {
    step: "04",
    title: "Acompanhamento",
    description: "Monitoramento contínuo e ajustes conforme mudanças legais e patrimoniais.",
  },
];
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-[15px] text-muted-foreground font-light max-w-md leading-relaxed mb-10">
              Estruturas jurídicas sólidas para proteção, sucessão familiar e eficiência tributária.
            </p>
            <a
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-[15px] text-muted-foreground font-light max-w-sm mx-auto leading-relaxed mb-10">
              Diagnóstico patrimonial estratégico com nossos especialistas
            </p>
